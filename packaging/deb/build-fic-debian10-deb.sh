...
PACKAGE_DISTRO_TAG="${PACKAGE_DISTRO_TAG:-debian10}"
...
build_project() {
    ...
    cmake \
        ...
        -DCMAKE_MODULE_PATH="$ROOT_DIR/packaging/deb/cmake" \
        -DCMAKE_CXX_STANDARD_LIBRARIES="${CMAKE_CXX_STANDARD_LIBRARIES:-} -lstdc++fs"
